...
package ly.neptune.nexus.fcms.fxhousesclient.reports.internal
...
import ly.neptune.nexus.fcms.fxhousesclient.reports.FcmsFxReportsClient
...
internal class FcmsFxReportsClientImpl(
    ...
    override suspend fun purchaseRequestsStatesSummary(
        approvedOn: String?,
        type: String?,
        ...
        val url = buildString {
            append(base)
            append("/api/v1/reports/purchase-requests-states")
            var first = true
            ...
            addParam("filter[approved_on]", approvedOn)
            addParam("filter[type]", type)
        }
        ...
        body.use { rb ->
            return JsonSupport.readSingleEnvelope(rb.byteStream(), PurchaseRequestsStatesReport::class.java)
        }
    }
